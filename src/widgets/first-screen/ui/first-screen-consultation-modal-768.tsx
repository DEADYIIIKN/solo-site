...
function CloseIcon30() {
  return (
    <svg
      aria-hidden
      className="size-[30px] shrink-0 text-white"
      fill="none"
      viewBox="0 0 34 34"
...
/** Figma 783:9860 — карточка 504px, заголовок 32px */
export function FirstScreenConsultationModal768({
  ...
  setFormState,
  titleVariant = "task",
}: FirstScreenConsultationModal768Props) {
  const titleId = useId();
          ...
          {isSuccess ? (
            <div className="first-screen-consultation-modal font-sans flex w-full max-w-[490px] flex-col gap-[40px] overflow-visible rounded-[16px] bg-white px-[30px] pb-[35px] pt-[30px] shadow-none">
              <div className="flex w-full flex-col items-start gap-[24px] text-center text-[#0d0300]">
                <p
                  className="w-full text-[30px] font-bold lowercase leading-[1.1]"
                  id={successTitleId}
                >
                  скоро вернемся!
                </p>
            ...
            <form
              className="first-screen-consultation-modal font-sans flex w-full max-w-[504px] flex-col gap-[30px] overflow-visible rounded-[16px] bg-white p-[24px] shadow-none"
            ...
            >
            <p
              className="w-full text-[32px] font-bold lowercase leading-[0.9] text-[#0d0300]"
              id={titleId}
            >
            ...
            <div className="flex w-full flex-col gap-[36px]">
              {/* Figma 783:9867: имя и телефон в один ряд, gap 30 */}
              ...
              <div className="flex w-full flex-col gap-[12px]">
                ...
                {/* Figma 783:9872: один ряд, gap 16 */}
              ...
              <label className="flex min-w-0 cursor-pointer items-center gap-[12px] leading-[0]">
                ...
                <span className="min-w-0 flex-1 text-[14px] font-normal leading-[1.2] text-[#0d0300] opacity-90">
