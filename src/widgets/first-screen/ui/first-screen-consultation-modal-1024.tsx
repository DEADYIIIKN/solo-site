...
export function FirstScreenConsultationModal1024({
  ...
  const layer = (
    <div
      ...
      aria-modal="true"
      className={`fixed inset-0 z-[520] hidden overflow-x-clip min-[1024px]:block min-[1440px]:hidden transition-opacity ease-[cubic-bezier(0.33,1,0.68,1)] will-change-[opacity] ${
