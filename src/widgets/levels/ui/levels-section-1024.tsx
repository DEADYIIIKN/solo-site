...
export function LevelsUnified1024() {
  ...
  return (
    ...
    >
      ...
      >
        <p className="m-0 text-[14px] font-medium leading-[0.9] text-[#5e524d]">{levels[0].label}</p>
      ...
      >
        <p className="m-0 text-[14px] font-medium leading-[0.9] text-[#5e524d]">{levels[1].label}</p>
      ...
      >
        <p className="m-0 text-[14px] font-medium leading-[0.9] text-[#5e524d]">{levels[2].label}</p>
