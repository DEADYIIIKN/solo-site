...
export function PhilosophyClientsMarquee1440() {
  ...
  return (
    <>
      ...
      <div className="absolute left-[-185px] top-0 z-[8] flex h-[214.314px] w-[1809.041px] items-center justify-start overflow-hidden">
      ...
      <div className="absolute left-[-158.19px] top-[170.36px] z-[8] flex h-[181.069px] w-[1755.063px] items-center justify-start overflow-hidden">
