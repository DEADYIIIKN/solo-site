...
/** Figma 783:11225 — заголовок по центру, карточки 432×270 */
export function PhilosophyClients480() {
  ...
  return (
    <div className="w-full min-w-0">
      <section
        ...
        id="philosophy-clients-480"
      >
        <div className="w-full rounded-bl-[60px] rounded-br-[60px] bg-white">
          <div className="relative mx-auto w-full max-w-[480px]">
            <div className="flex flex-col items-center gap-[60px] px-6 py-20">
            <div ref={titleRef}>
              <div
                className={cn(
                  philosophyNarrowRevealTransition,
            ...
            <PhilosophyClientsNarrowClientsBlock eyebrowPlClassName="flex w-full justify-center px-6" />
          </div>
        </div>
      </section>
    </div>
