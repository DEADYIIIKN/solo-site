...
/**
 * Figma 783:9034 — «footer» 1440px: тёмный блок с разделом блога и нижней информацией.
 */
export function Footer1440({ showSecrets = true }: { showSecrets?: boolean }) {
  ...
  return (
    <footer
      className="relative hidden w-full bg-[#0d0300] min-[1440px]:block"
      id="footer-1440"
    >
      {/* Background grid */}
      <div
      ...
      {/* Main content */}
      <div className="relative mx-auto flex max-w-[1440px] flex-col gap-[200px] px-[140px] py-[120px]">
        ...
        {showSecrets && <div className="flex flex-col gap-[60px]">
          ...
          <div className="flex items-end justify-between pl-[30px]">
            <p className="m-0 font-bold lowercase leading-[0.9] text-[60px] text-white whitespace-nowrap">
          ...
          <div className="overflow-hidden">
            ...
            >
              {footerBlogPosts.map((post) => (
                <div
                  className="flex w-[480px] shrink-0 flex-col gap-[20px]"
                  key={post.id}
                >
                  {/* Card image */}
                  ...
                  {/* Card title */}
                  <p className="m-0 ml-[30px] w-[420px] font-bold lowercase leading-[0.9] tracking-[0.24px] text-[24px] text-white">
        ...
        <div
          className="grid"
          style={{
            gridTemplateColumns: "575px 380px",
            columnGap: "205px",
            rowGap: "120px",
        ...
        >
          ...
          <div className="flex flex-col gap-[30px] self-start">
            <div className="flex flex-col gap-[20px]">
              <p className="m-0 font-normal leading-[1.2] text-[17px] text-[#9c9c9c]">
                {footerContent.phoneSubtitle}
              </p>
            <a
              className="m-0 font-bold leading-none text-[40px] no-underline transition-opacity hover:opacity-70"
          ...
          <div className="flex flex-col gap-[19px] self-start">
            <p className="m-0 w-[270px] font-normal leading-[1.2] text-[17px] text-white">
