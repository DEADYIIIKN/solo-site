    ...
    >
      <div className="w-full bg-white">
        ...
        >
          ...
          <p className="min-w-full text-center text-[0] text-[#0d0300]" style={{ lineHeight: 0.9 }}>
            <span className="text-[18px] font-bold" style={{ lineHeight: 0.9 }}>
              Создаем рекламу и контент для&nbsp;соцсетей, которые{" "}
            </span>
            <span className="text-[18px] font-normal italic" style={{ lineHeight: 0.9 }}>
              системно приводят клиентов
            </span>
            <span className="text-[18px] font-bold" style={{ lineHeight: 0.9 }}> в&nbsp;ваш бизнес.</span>
          </p>
        </div>
        ...
        <div className="text-center" ref={manifestoRef}>
          ...
          >
            <span className="text-[18px] font-bold" style={{ lineHeight: 0.9 }}>Мы </span>
            <span className="text-[18px] font-normal italic" style={{ lineHeight: 0.9 }}>
