...
All type values are pre-existing — Phase 3 fixes line-height bugs to match Figma, does not introduce new type styles.
...
| Cases section heading (768) | 44px | 700 | 0.9 | Already correct — do not change |
| Cases section heading (360) | 28px | 700 | 0.9 | Already correct — do not change |
| Levels label text (768) | 12px | 500 | 0.9 | Verify absolute top position against Figma |
| Levels title text (768) | 20px | 700 | 1 (leading-none) | Verify absolute top position against Figma |
| Levels label text (360) | 10px | 500 | 0.9 | Verify absolute top position against Figma |
| Levels title text (360) | 14px | 700 | 1 (leading-none) | Verify absolute top position against Figma |
| Eyebrow | 14px | 600 | 1.2 | Already correct — do not change |

**Key fix rule:** For LY820-04 and LY360-05 (cases credits line-height):
- Current code: `leading-[1.2]` on credits rows + `mb-[10px]` (768) / `mb-[6px]` (360) spacing.
...
3. Verify `mb-[10px]` (768) and `mb-[6px]` (360) spacing between credit rows against Figma.
